...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=test&box=23.500962,62.167467,23.154634,62.005771
...
[!] If you look at one height map, look at this one. [!]
  ...
  * test Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 49m (actual) is equal to 40m in
