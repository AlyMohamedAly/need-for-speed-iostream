...
Game.createFirstScene = function () {
    ...
    portal.position.x = 610;
    portal.position.y = 2.5;
    portal.position.z = 245;
    ...
    touchPowerups(tank, PowerUps, particleSystem, scene);
    ...
    Game.scenes[0].applyTankMovements = function (tank) {
...
Game.createSecondScene = function () {
    ...
    tank.position.x = 612;
    tank.position.z = 419;
    Game.scenes[1].applyTankMovements = function (tank) {
        //console.log(tank.position);
        if (isWPressed) {
...
//    //optimize here
    ...
    function touchPowerups(tank, PowerUps, particleSystem, scene) {
        if (!PowerUps[0].broken && tank.intersectsMesh(PowerUps[3], false)) {
            var temp3 = PowerUps[0].position;
